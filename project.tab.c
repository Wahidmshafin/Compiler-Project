...
static const char *const yytname[] =
{
  ...
  "SORT", "statements", "GREATER", "LESS", "GOE", "LOE", "NOT_EQUAL",
  "EQUAL", "MOD", "POWER", "DIV", "MUL", "MINUS", "PLUS", "MMINUS",
  "PPLUS", "'^'", "$accept", "program", 0
};
#endif
